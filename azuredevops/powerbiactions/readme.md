...
* Add a new Admin users to a Power BI workspace.
...
* Users: The users that should be added as Admin to the workspace (seperated by ',')
...
[serviceconnection]: images/serviceconnection.png "Power BI Service Connection"